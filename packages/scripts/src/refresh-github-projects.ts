...
async function getPinnedGitHubProjects(owner: string, limit: number): Promise<GitHubProject[]> {
...
async function getRecentGitHubProjects(owner: string, limit: number): Promise<GitHubProject[]> {
