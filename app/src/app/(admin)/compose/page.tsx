      ...
      <form action={createPostAction} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
          <p className="mt-1 text-xs text-gray-500">Upload images under /uploads or reference existing /images assets.</p>
        </div>
        <div>
        ...
        <div className="flex justify-end gap-3">
          <button type="reset" className="rounded-full border border-gray-300 px-5 py-2 text-sm font-semibold text-gray-600 hover:border-gray-400">
            Reset
          </button>
