import {
  ...
  DEFAULT_GITHUB_OWNER as CORE_DEFAULT_GITHUB_OWNER,
  DEFAULT_GITHUB_REPO as CORE_DEFAULT_GITHUB_REPO,
  DEFAULT_DATABASE_URL as CORE_DEFAULT_DATABASE_URL,
  DEFAULT_NEXTAUTH_SECRET as CORE_DEFAULT_NEXTAUTH_SECRET,
  DEFAULT_UPLOADS_DIR as CORE_DEFAULT_UPLOADS_DIR,
...
export const DEFAULT_DATABASE_URL = CORE_DEFAULT_DATABASE_URL;
export const DEFAULT_UPLOADS_DIR = CORE_DEFAULT_UPLOADS_DIR;
export const DEFAULT_NEXTAUTH_SECRET = CORE_DEFAULT_NEXTAUTH_SECRET;
export const DEFAULT_GITHUB_OWNER = CORE_DEFAULT_GITHUB_OWNER;
export const DEFAULT_GITHUB_REPO = CORE_DEFAULT_GITHUB_REPO;
