...
export function GitHubProjectCard({
  ...
  return (
    <a
      ...
      data-testid={testId}
      className={cn(
        "group block h-full rounded-2xl border border-border/60 bg-card/80 p-5 shadow-[0_18px_45px_rgba(6,10,20,0.45)] transition hover:-translate-y-0.5 hover:border-primary/40 hover:bg-card",
        className,
      )}
    >
